...
class ProductDocs(models.Model):
    ...
    # product_variant = fields.Many2one('product.product', string='Product Variant', domain=lambda self: [('product_tmpl_id', '=', self.env.context.get('default_product_tmpl_id'))])
